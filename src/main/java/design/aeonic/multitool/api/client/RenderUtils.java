...
public class RenderUtils {
     ...
     * Renders a structure.
     */
    public static void drawStructure(PoseStack stack, MultiBufferSource.BufferSource source, float partialTicks, Vector3f position, BuildableStructure structure, StructureSyncHandler.StructureInfo info, Direction direction, float r, float g, float b, float a, boolean drawBoundingBox) {
        ...
        if (drawBoundingBox) {
            LevelRenderer.renderLineBox(stack, source.getBuffer(RenderType.lines()), 0, 0, 0, size.getX(), size.getY(), size.getZ(), r, g, b, Math.min(1, a * 1.5f));
            source.endBatch();
        }
    ...
    public static void drawStructure(PoseStack stack, MultiBufferSource.BufferSource source, BlockRenderDispatcher renderer, BuildableStructure structure, StructureSyncHandler.StructureInfo blocks, float r, float g, float b, float a) {
    ...
    public static void drawRelativeBlock(PoseStack stack, VertexConsumer cons, BlockRenderDispatcher renderer, Random random, StructureSyncHandler.PosAndState block, float r, float g, float b, float a) {
        stack.pushPose();
