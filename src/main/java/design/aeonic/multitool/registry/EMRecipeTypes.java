...
public class EMRecipeTypes {
    public static final Supplier<RecipeType<StructureBuildingRecipe>> MULTITOOL_BUILDING = Suppliers.memoize(() -> RecipeType.register(Constants.MOD_ID + ":multitool_building"));
